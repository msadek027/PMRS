...
=======
>>>>>>> 2ad3a468a6431460147149bd85dc330d7a800a8b
    $http({
        method: "GET",
    ...
    $scope.GetWaitingListForAdministrative = function () {
...
>>>>>>> 2ad3a468a6431460147149bd85dc330d7a800a8b
    var columnResolutionList = [
        ...
        { name: 'MemberResolutionDetail', displayName: "মূল প্রস্তাব", visible: false, width: 150, cellTemplate: '<div ng-bind-html="COL_FIELD"></div>' },
    ...
    $scope.GetSearchForEditAdministrativeOfficer = function () {

        $scope.gridDepartmentOptions.data = [];
        $http({
            method: "GET",
            url: MyApp.rootPath + "ResolutionApproval/GetSearchForEditAdministrativeOfficer"
        }).then(function (response) {
            if (response.data.length > 0) {
    ...
    $scope.GetPostedHistoryListByAdministrativeOfficer = function () {

        $scope.gridDepartmentOptions.data = [];
        $http({
            method: "GET",
            url: MyApp.rootPath + "ResolutionApproval/GetPostedHistoryListByAdministrativeOfficer"
        }).then(function (response) {
            if (response.data.length > 0) {
    ...
    var columnDepartmentList = [
        ...
        { name: 'MemberResolutionDate', displayName: "প্রস্তাবের তারিখ", cellFilter: "FullDateWithTime", width: 150 },
        { name: 'html', displayName: "সিদ্ধান্ত প্রস্তাব", width: 630, cellTemplate: '<div ng-bind-html="COL_FIELD"></div>' },
        ...
        { name: 'AcceptanceComment', displayName: "গ্রহনযোগ্যতা", visible: false },
        { name: 'RDNo', displayName: "আর ডি নং", width: 100 },
        { name: 'AdministrativeOfcApproveStatus', displayName: "Status", width: 120 },
        { name: 'AdministrativeOfcDetail', displayName: "Status", visible: false },
        { name: 'AdministrativeOfcDetail', displayName: "Status", visible: false },
    ...
    $scope.rowDblClickCompApproval = function (row) {
        ...
        $scope.AcceptanceComment = row.entity.AcceptanceComment;
        $scope.RDNo = row.entity.RDNo;
        $scope.frmAdministrativeOfficerApproval.ParliamentSession = row.entity.ParlSessID;

        $scope.ApproveDetail = row.entity.AdministrativeOfcDetail;
        $scope.ApproveDate = $filter('FullDateTime')(row.entity.AdministrativeOfcDetail);
        $scope.frmAdministrativeOfficerApproval.AppStatus = row.entity.AprID;
        $scope.GetResolutionLog(row.entity.MemberResolutionID);
    ...
    $scope.SaveData = function () {
        debugger;
        if ($scope.frmAdministrativeOfficerApproval.AppStatus === '' || $scope.frmAdministrativeOfficerApproval.AppStatus === undefined) {
            toastr.warning("সিদ্ধান্ত-প্রস্তাবের মতামত প্রদান করুন");
            return false;
        }
        if ($scope.frmAdministrativeOfficerApproval.SignTo === '' || $scope.frmAdministrativeOfficerApproval.SignTo === undefined || $scope.frmAdministrativeOfficerApproval.SignTo === 'undefined') {
            toastr.warning("প্রাপোক নির্বাচন করুন");
            return false;
        }
    ...
    $scope.Reset = function () {
        ...
        $scope.RDNo = "";
        $scope.frmAdministrativeOfficerApproval.ParliamentSession = "";
