app.controller("myCtrl", function ($scope, $http, $filter) {
    ...
    $scope.GetAuditTrail = function () {
        $http({
            ...
            data: { FromDate: $scope.FromDate, ToDate: $scope.ToDate, Action_By: $scope.frmRptAuditTrail.Emp_ID, Action_Type: $scope.ActionType }
        }).then(function (response) {
            if (response.data != "") {
    ...
    var columnAuditTrail = [
        { name: 'EmployeeName', displayName: "Action By", width: "220" },
        //{ name: 'ProposalID', displayName: "ProposalID", visible: false },
        { name: 'DepartmentName', displayName: "Department", width: "200" },
        { name: 'DesignationName', displayName: "Designation", width: "100" },
        { name: 'Terminal', displayName: "Terminal", width: "120" },
        { name: 'Action_Date', displayName: "Action Date", cellFilter: "FullDateTime", width: "100" },
        { name: 'Activity_Type', displayName: "Action Type", width: "100", visible: false },
        { name: 'Action_Form', displayName: "Form", width: "180" },
        ...
        { name: 'Project_Name', displayName: "Project", width: "180" }
